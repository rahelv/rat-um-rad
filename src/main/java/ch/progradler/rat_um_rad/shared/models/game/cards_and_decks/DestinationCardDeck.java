...
public class DestinationCardDeck implements CardDeck {
    ...
    public static DestinationCardDeck shortDestinations() {
        ...
        City city2 = new City("CityId2", "CityName2", new Point(1, 1));
        City city3 = new City("CityId3", "CityName3", new Point(1, 1));
        City city4 = new City("CityId4", "CityName4", new Point(1, 1));
        City city5 = new City("CityId5", "CityName5", new Point(1, 1));
        destinationCards.add(new DestinationCard("CardId1", city1, city1, 1));
        destinationCards.add(new DestinationCard("CardId2", city2, city1, 1));
        destinationCards.add(new DestinationCard("CardId3", city3, city1, 1));
        destinationCards.add(new DestinationCard("CardId4", city4, city1, 1));
        destinationCards.add(new DestinationCard("CardId5", city5, city1, 1));
        destinationCards.add(new DestinationCard("CardId6", city2, city1, 1));
        destinationCards.add(new DestinationCard("CardId7", city3, city3, 1));
        destinationCards.add(new DestinationCard("CardId8", city4, city5, 1));
        destinationCards.add(new DestinationCard("CardId9", city4, city2, 1));
